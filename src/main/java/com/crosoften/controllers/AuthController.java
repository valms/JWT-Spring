...
public class AuthController {
    ...
    /**
     * @param signUpRequest Request para a criação de ua conta
     * @return Em caso de sucesso, cria um usuário e retorna um token de acesso
     */
    @PostMapping("/signup")
...
//		Arrays.stream( files ).map( file -> uploadFile( file, profile ) ).collect( Collectors.toList() );
    ...
    /**
     * @param loginRequest Request para o acesso do usuário para a autenticação do usuário
     * @return em caso de sucesso, retorna um token em formato JWT.
     */
    @PostMapping("/signin")
